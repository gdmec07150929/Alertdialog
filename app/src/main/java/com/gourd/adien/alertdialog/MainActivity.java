package com.gourd.adien.alertdialog;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void dialog1() {
        ...
        dialog.setButton(DialogInterface.BUTTON_POSITIVE,"退出",list1);
    ...
    private void dialog2() {
        ...
        dialog.setButton(DialogInterface.BUTTON_POSITIVE,"很忙",list2);
        dialog.setButton(DialogInterface.BUTTON_NEGATIVE,"很闲",list2);
    ...
    private void dialog3() {
        ...
        dialog.setButton(DialogInterface.BUTTON_NEGATIVE,"确定",list3);
        dialog.show();
    }
    ...
    private void dialog4() {
        ...
        dialog.setTitle("多选框");
        DialogInterface.OnClickListener list41 = new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                String str = "你选了";
        ...
        dialog.setButton(DialogInterface.BUTTON_NEGATIVE,"确定",list41);
        dialog.show();
    }
    ...
    private void dialog5() {
        ...
        dialog = builder.create();
        dialog.setTitle("单选");
        DialogInterface.OnClickListener list51 = new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                String str = "你选了";
                for(int i = 0;i<bSelect.length;i++){
        ...
        dialog.setButton(AlertDialog.BUTTON_POSITIVE,"确定",list51);
        dialog.show();
    }
    ...
    private void dialog6() {
        ...
        DialogInterface.OnClickListener list61 = new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
            }
        };
        dialog.setButton(AlertDialog.BUTTON_POSITIVE,"确定",list61);
        dialog.show();
    }
